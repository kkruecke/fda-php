...
class TextFileInserter extends AbstractFileInserter implements DatabaseUpdateInterface {
   ...
   public function __construct(string $file_name, \PDO $db_handle)
   {
   ...
   public function processLine(string $text, int $line_number) : void
   {
          ...
          */
          ...
          if ( (binary_search($mdr_report_key, $this->mdrfoi_mdr_report_keys) === FALSE) || ($mdr_report_key ==  $this->prior_mdr_report_key) ) {
